...
<head>
	...
	<title>Unlock Cell</title>

	<!-- Custom styles for this template-->
	<link href="css/sb-admin-2.min.css" rel="stylesheet">
	<link rel="stylesheet" href="css/dataTables.bootstrap4.min.css">

	<link rel="icon" href="../sistema/img/logo.jpg">
</head>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				<!-- Topbar -->
				<nav style="background-color:#0031A9" class="navbar navbar-expand navbar-light text-white topbar mb-4 static-top shadow">
					...
					<div class="input-group">
						<h4><font face="Comic Sans MS,arial"></font> UNLOCK CELL</h4>
