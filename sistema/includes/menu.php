<!-- Sidebar -->
<ul style="background-color:#0031A9" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		...
		<div class="sidebar-brand-text mx-3">Unlock Cell</div>
	</a>
	...
	<li class="nav-item">
		...
		<div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo1" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="registro_reparacion.php">Nueva reparacion</a>
				<a class="collapse-item" href="lista_reparacion.php">Reparaciones</a>
			</div>
		</div>
	</li>
