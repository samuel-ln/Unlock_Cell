        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="dni">No. DPI (CUI)</label>
                    <input type="number" placeholder="Ingrese el numero del DPI" name="dni" id="dni" class="form-control" required minlength="15" maxlength="15">
                </div>
                <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" placeholder="Ingrese Nombre Completo" name="nombre" id="nombre" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="telefono">Teléfono</label>
                    <input type="number" placeholder="Ingrese Teléfono" name="telefono" id="telefono" class="form-control" required minlength="8" maxlength="8">
                </div>
                <div class="form-group">
